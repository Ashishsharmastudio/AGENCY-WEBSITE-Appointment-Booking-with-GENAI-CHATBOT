...
function LoadingFallback() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] px-6 py-10 text-white">
  ...
  return (
    ...
    >
      <div className="text-center mb-6  sm:mb-8">
        <h1 className="text-3xl sm:text-5xl font-extrabold bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">
          Book an Appointment
        </h1>
        ...
        <div>
          <button
            ...
            className={`w-full py-3 rounded-xl font-bold text-black ${
              loading
                ? "bg-gray-500"
                : "bg-linear-to-r from-purple-400 to-cyan-300"
            }`}
          >
...
export default function BookingPage() {
  return (
    <section className="flex items-center justify-center min-h-screen bg-linear-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] px-4 sm:px-6 py-10 text-white relative overflow-hidden">
      {/* Background accents */}
