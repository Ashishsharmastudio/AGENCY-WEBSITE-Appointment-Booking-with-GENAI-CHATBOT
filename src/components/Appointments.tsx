              ...
              <div className="text-gray-300 flex flex-col gap-1 mt-2">
                ...
                {a.user?.email && (
                  <p className="flex items-center gap-2 text-sm">
                    ...
                    <span className="inline-block bg-white/6 text-cyan-100 px-2 py-0.5 rounded-md">
                      {a.user.email}
                    </span>
                  </p>
                )}
                {a.user?.mobile && (
                  <p className="flex items-center gap-2 text-sm">
                    <svg
                      ...
                      strokeLinejoin="round"
                    >
                      <path d="M22 16.92V21a1 1 0 0 1-1.11 1 19.86 19.86 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.86 19.86 0 0 1 2 3.11 1 1 0 0 1 3 2h4.09a1 1 0 0 1 1 .75c.12.65.28 1.28.48 1.88a1 1 0 0 1-.25 1l-1.2 1.2a16 16 0 0 0 6 6l1.2-1.2a1 1 0 0 1 1-.25c.6.2 1.23.36 1.88.48a1 1 0 0 1 .75 1V21z" />
                    </svg>
                    <span className="inline-block bg-linear-to-r from-purple-400 to-cyan-300 text-black px-3 py-1 rounded-full">
                      {a.service}
                    </span>
                  </p>
                )}
